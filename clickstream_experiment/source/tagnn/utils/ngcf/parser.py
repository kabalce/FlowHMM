...
def parse_args():
    ...
    parser.add_argument('--weights_path', nargs='?', default='models/ngcf/',
                        help='Store model path.')
    parser.add_argument('--data_path', nargs='?', default='data/processed/ngcf/',
    ...
    parser.add_argument('--item_embeddings', type=bool, default=False,
                        help='Whether to use item_embeddings.npy for initialization.')
