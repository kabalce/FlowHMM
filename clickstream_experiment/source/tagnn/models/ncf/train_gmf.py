...
from src.models.ncf.gmf import GeneralizedMatrixFactorization
...
def main(
    ...
    wandb_logger = WandbLogger(project="GeneralizedMatrixFactorization", entity="cirglaboratory", name=name)
    ...
    if save_path is not None:
        torch.save(model.gmf.state_dict(), save_path + '/gmf.pt')
