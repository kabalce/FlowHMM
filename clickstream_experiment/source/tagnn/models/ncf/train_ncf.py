...
from src.models.ncf.ncf import NeuralCollaborativeFiltering
...
@click.option('--pretrained_path', type=click.STRING)
def main(
        name, dataset, variant, dataset_path, layer_sizes, embedding_dim, epochs, batch_size, validation, test,
        num_negatives, lr, lr_decay, lr_step_size, weight_decay, embeddings, unfreeze_after, pretrained_path
):
    wandb_logger = WandbLogger(project="NeuralCollaborativeFiltering", entity="cirglaboratory", name=name)
